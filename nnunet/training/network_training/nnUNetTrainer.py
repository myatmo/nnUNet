...
class nnUNetTrainer(NetworkTrainer):
    ...
    def finish_online_evaluation(self):
        ...
        dice_score = [np.round(i, 4) for i in global_dc_per_class]
        self.print_to_log_file("Average global foreground Dice:", dice_score)
        self.print_to_log_file("(interpret this as an estimate for the Dice of the different classes. This is not "
                               "exact.)")
        self.run["train/accuracy"].append(dice_score[0]) # assuming it's for binary segmentation
